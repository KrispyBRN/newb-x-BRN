...
/* Aurora */
#define NL_AURORA 2.0                   // [toggle] 0.1 dim - 4.0 bright
#define NL_AURORA_SPEED 0.03            // 0.01 slow motion - 0.2 fast motion
#define NL_AURORA_DAY_VISIBILITY 0.01   // 0.0 invisible - 1.0 visible
#define NL_AURORA_COLOR  vec3(0.25,1.4,0.9) // aurora green layer
#define NL_AURORA_COLOR2 vec3(1.3,0.3,1.6)  // aurora purple layer
